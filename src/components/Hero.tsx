  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] rounded-full bg-primary/8 blur-[150px]" />
      ...
      <div className="container relative z-10 text-center max-w-3xl mx-auto px-4">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-medium"
          >
          ...
          {/* Heading */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-foreground leading-[1.05]">
            Your money,
            <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <motion.a
              href="/app"
              className="inline-flex h-13 px-8 items-center rounded-2xl bg-primary text-primary-foreground text-sm font-bold shadow-glow hover:shadow-[0_0_80px_-12px_hsl(72_100%_60%_/_0.3)] transition-shadow duration-300"
