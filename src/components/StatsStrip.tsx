...
const StatsStrip = () => {
  return (
    <section className="py-8 sm:py-12 border-y border-border bg-card/30">
      <div className="container px-4 sm:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          {stats.map((stat, i) => (
            ...
            >
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground tracking-tight font-display">
                {stat.value}
              </p>
